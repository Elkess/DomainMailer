      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900 p-4">
        ...
        <div className="space-y-2">
          {summary.accountStats.map((account) => (
            <div key={account.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 rounded-lg border border-slate-800 bg-slate-950 px-3 py-2 text-sm">
