...
export const api = {
  ...
  getLeads: (campaignId: string) =>
    request<{ leads: Array<{ id: string; email: string; status: string; sentAt: string | null; createdAt: string; currentSequenceStep?: number; receivedReply?: boolean; error_message?: string | null }> }>(`/campaigns/${campaignId}/leads`)
};
